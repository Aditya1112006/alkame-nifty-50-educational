...
from scalping import ScalpingEngine, ScalpSetup
...
def test_scalping_engine_find_opportunities():
    ...
    # Mock stock data
    df = pd.DataFrame({"Close": [100.0, 101.0, 102.0], "High": [101.0, 102.0, 103.0], "Low": [99.0, 100.0, 101.0], "Volume": [100, 200, 300], "ATR_14": [1.0, 1.0, 1.0]})
